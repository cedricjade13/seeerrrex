...
// Fetch the last submitted data (assuming you want the most recent entry)
$sql = "SELECT * FROM personal_data ORDER BY id DESC LIMIT 1"; // Adjust the query based on your needs
            ...
            <div class="data-grid">
                ...
                <div class="data-item">
                    ...
                    <div>
                        ...
                        $otherCivilStatus = htmlspecialchars($row['other_civil_status']); // Fetch the other civil status
                        if ($civilStatus !== 'Others' && !empty($otherCivilStatus)) {
                        echo $otherCivilStatus; // Display the specified value
                        } else {
                            echo $civilStatus; // Display the selected value
                        }
                        ?>
                    </div>
                </div>
